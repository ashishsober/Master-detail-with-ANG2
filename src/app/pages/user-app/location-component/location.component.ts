...
BG_COLOR = "006600";
  ngOnInit(){
    ...
    this.write_settings_frame(); //calling write_frame ca,, for setting
...
player(name, bankroll, carda, cardb, status, total_bet, subtotal_bet) {
  this.name = name;
...
my_players = [
  new this.player("Gus Handsome", 0, "", "", "", 0, 0),
  new this.player("Karth Kerai", 0, "", "", "", 0, 0),
  new this.player("Tonya Bonya", 0, "", "", "", 0, 0),
  new this.player("Stan Deman", 0, "", "", "", 0, 0)
];
...
new_game() {
  ...
  this.players[0] = new this.player(player_name, 0, "", "", "", 0, 0);
